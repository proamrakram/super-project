                                ...
                                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                                    ...
                                    <div class="bs-stepper-content px-0 mt-4">
                                        <div>
                                            ...
                                            <form action="{{ route('admin.update.user.permissions', $user->id) }}"
                                                method="POST">
                                                @csrf
                                                                ...
                                                                <tr>
                                                                    <div class="col-md-6 mt-1">
                                                                        ...
                                                                        <select class="select2 form-select"
                                                                            ...
                                                                            <option value="admin"
                                                                                @if ($user->user_type == 'admin') selected @endif>
                                                                                مدير</option>
                                                                            <option value="office"
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    name="can_show_sells"
                                                                                    @if ($user->permissions->can_show_sells == 1) checked @endif>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    name="can_add_sells"
                                                                                    @if ($user->permissions->can_add_sells == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    name="can_edit_sells"
                                                                                    @if ($user->permissions->can_edit_sells == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canEdit"> تعديل
                                                                                </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_cancel_sells == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_show_offers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canShow"> رؤية </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    name="can_add_offers"
                                                                                    @if ($user->permissions->can_add_offers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canAdd"> اضافة </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_edit_offers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canEdit"> تعديل
                                                                                </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_cancel_offers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canCancel">إلغاء</label>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_show_vouchers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canShow"> رؤية </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_add_vouchers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canAdd"> اضافة </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_edit_vouchers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canEdit"> تعديل
                                                                                </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check me-3 me-lg-5">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    @if ($user->permissions->can_cancel_vouchers == 1) checked @endif>
                                                                                <label class="form-check-label"
                                                                                    for="canCancel">إلغاء</label>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    @if ($user->permissions->can_booking == 1) checked @endif>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    class="form-check-input"
                                                                                    @if ($user->permissions->can_send_sms == 1) checked @endif
