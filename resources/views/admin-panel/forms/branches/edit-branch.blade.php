                                ...
                                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                                        ...
                                        <div class="step" data-target="#account-details" role="tab"
                                            ...
                                            <button type="button" class="step-trigger">
                                                ...
                                                <span class="bs-stepper-label">
                                                    <span class="bs-stepper-title">تعديل بيانات الفرع</span>
                                                </span>
                                            </button>
                                        </div>
                                    ...
                                    <div class="bs-stepper-content px-0 mt-4">
                                        ...
                                        <div id="account-details" class="content">
                                            ...
                                            <form action="{{ route('admin.edit.branch', $branch->id) }}" method="POST"
                                                class="row gy-1 gx-2 needs-validation invalid was-validated form form-horizontal"
                                                novalidate id="addNewAddressForm">
                                                @csrf

                                                <div class="content-header mb-2">
                                                    <h2 class="fw-bolder mb-75">بيانات الفرع</h2>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        ...
                                                        <input type="" id="branch-code" name='branch_code'
                                                            class="form-control" value="{{ $branch->code }}"
                                                            placeholder="مثال : QTF "required />
                                                        @error('branch_code')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
